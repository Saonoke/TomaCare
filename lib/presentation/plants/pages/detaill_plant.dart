  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocConsumer<PlantsBloc, PlantsState>(builder: (context, state) {
        switch (state) {
          case PlantsInitial():
            context.read<PlantsBloc>().add(PlantRequestById(id: widget.index));
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          Navigator.of(dialogContext)
                                              .pop(); // Tutup dialog
                                          // Kirim event untuk menghapus data
                                          context.read<PlantsBloc>().add(
                                              PlantDelete(id: widget.index));
                                        },
                                        child: const Text(
                                          'Hapus',
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                plant.condition,
                                style:
                                    TextStyle(fontSize: 16, color: neutral06),
                              ),
                            ),
                          ],
                        ),
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                DateTime tanggal =
                                    DateFormat("yyyy-MM-dd").parse(date[index]);
